...
DatePicker.prototype.init = function(parentView) {
...
// Used to show the date picker.
DatePicker.prototype.open = function(callback) {
	var self = this;
...
// Used to hide the date picker.
DatePicker.prototype.close = function() {
	var self = this;
	self.callback(self.datePick.value);
	self.pickerView.animate({
...
DatePicker.prototype.setValue = function(dateObj) {
	var self = this;
	return self.datePick.setValue(dateObj);
};
